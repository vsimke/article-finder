...
class BingArticleParser extends AbstractParser
{
    public const BASE_URI = 'https://www.bing.com';
    ...
    public function parse(hQuery $html): array
    {
        ...
        foreach ($html->find('h2 > a[href]') ?? [] as $linkElement) {
            $text = mb_convert_encoding(str_replace(' …', '', (string) $linkElement->text()), 'utf-8', $charset);
